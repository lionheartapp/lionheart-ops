...
34 marketing skills are installed in `.Codex/skills/`. Use them when working on any marketing-related task:
...
### Continuous Learning
After completing any significant work, update the memory files at `~/.Codex/projects/-Users-mkerley-Desktop-Lionheart/memory/` with:
