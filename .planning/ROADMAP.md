...
- [ ] **Phase 8: Auth Hardening and Security** - Production-grade auth: forgot password, rate limiting, httpOnly cookies, CSRF, email verification, input sanitization, and webhook signatures
...
| 8. Auth Hardening and Security | v2.0 | 0/5 | Not started | - |
