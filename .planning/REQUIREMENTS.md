...
- [x] **AI-02**: AI generates a registration form based on event type and parameters
- [x] **AI-03**: AI generates initial group assignments based on constraints (gender, grade, friend requests, counselor ratios)
- [x] **AI-04**: AI detects scheduling conflicts beyond date/room overlap (weather risk, testing schedules, audience overlap)
...
- [x] **AI-09**: AI analyzes post-event feedback surveys and surfaces actionable themes
