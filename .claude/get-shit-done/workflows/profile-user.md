...
Key references:
- @/Users/mkerley/Desktop/Linfield Test/.claude/get-shit-done/references/ui-brand.md (display patterns)
- @/Users/mkerley/Desktop/Linfield Test/.claude/get-shit-done/agents/gsd-user-profiler.md (profiler agent definition)
- @/Users/mkerley/Desktop/Linfield Test/.claude/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="/Users/mkerley/Desktop/Linfield Test/.claude/get-shit-done/USER-PROFILE.md"
...
```bash
cp "/Users/mkerley/Desktop/Linfield Test/.claude/get-shit-done/USER-PROFILE.md" "/Users/mkerley/Desktop/Linfield Test/.claude/USER-PROFILE.backup.md"
```
...
✓ Stores profile at /Users/mkerley/Desktop/Linfield Test/.claude/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `/Users/mkerley/Desktop/Linfield Test/.claude/get-shit-done/references/user-profiling.md`
...
Reference: @/Users/mkerley/Desktop/Linfield Test/.claude/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to /Users/mkerley/Desktop/Linfield Test/.claude/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global CLAUDE.md" -- "Add profile to /Users/mkerley/Desktop/Linfield Test/.claude/CLAUDE.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /Users/mkerley/Desktop/Linfield Test/.claude/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at /Users/mkerley/Desktop/Linfield Test/.claude/commands/gsd/dev-preferences.md"
...
Display: "✓ Added profile section to /Users/mkerley/Desktop/Linfield Test/.claude/CLAUDE.md"
...
```bash
BACKUP_PATH="/Users/mkerley/Desktop/Linfield Test/.claude/USER-PROFILE.backup.md"
```
...
Your profile:    /Users/mkerley/Desktop/Linfield Test/.claude/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   /Users/mkerley/Desktop/Linfield Test/.claude/commands/gsd/dev-preferences.md
  ✓ CLAUDE.md section       ./CLAUDE.md
  ✓ Global CLAUDE.md        /Users/mkerley/Desktop/Linfield Test/.claude/CLAUDE.md
```
