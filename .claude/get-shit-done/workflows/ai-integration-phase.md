...
<required_reading>
@/Users/mkerley/Desktop/Linfield Test/.claude/get-shit-done/references/ai-frameworks.md
@/Users/mkerley/Desktop/Linfield Test/.claude/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read /Users/mkerley/Desktop/Linfield Test/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/Users/mkerley/Desktop/Linfield Test/.claude/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /Users/mkerley/Desktop/Linfield Test/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /Users/mkerley/Desktop/Linfield Test/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /Users/mkerley/Desktop/Linfield Test/.claude/agents/gsd-eval-planner.md for instructions.
