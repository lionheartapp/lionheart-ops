...
```
Task(
  prompt="Read /Users/mkerley/Desktop/Linfield Test/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/mkerley/Desktop/Linfield Test/.claude/get-shit-done/templates/VALIDATION.md`
