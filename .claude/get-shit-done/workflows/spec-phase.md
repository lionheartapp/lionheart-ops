...
```bash
INIT=$(node "/Users/mkerley/Desktop/Linfield Test/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/mkerley/Desktop/Linfield Test/.claude/get-shit-done/templates/spec.md.
