...
- **Global scope**: `/Users/mkerley/Desktop/Linfield Test/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/mkerley/Desktop/Linfield Test/.claude/notes/`)
...
2. Glob `/Users/mkerley/Desktop/Linfield Test/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/mkerley/Desktop/Linfield Test/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/mkerley/Desktop/Linfield Test/.claude/notes/` — works in any directory
