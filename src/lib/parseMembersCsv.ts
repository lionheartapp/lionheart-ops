 ...
 */
export type ParsedMember = { name: string; email: string; role?: string; teamNames?: string[] }

export function parseMembersCsv(text: string): ParsedMember[] {
  ...
  const teamsIdx = findColumnIndex(headerCols, ['teams', 'team', 'team tags'])
