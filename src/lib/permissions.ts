...
export const PERMISSIONS = {
  ...
  SETTINGS_SSO_MANAGE: 'settings:sso:manage',
  ...
  AV_READ: 'av:read',
  AV_MANAGE: 'av:manage',
  AV_COORDINATE: 'av:coordinate',
  AV_SCAN_UPLOAD: 'av:scan:upload',
  AV_BRIDGE_MANAGE: 'av:bridge:manage',
...
export const DEFAULT_ROLES = {
  ...
  ADMIN: {
    ...
    permissions: [
      ...
      PERMISSIONS.SETTINGS_SSO_MANAGE,
  ...
  HEAD_OF_SCHOOLS: {
    slug: 'head-of-schools',
    name: 'Head of Schools',
    description: 'District-level oversight of all schools and operations',
    permissions: [
      PERMISSIONS.TICKETS_CREATE,
      PERMISSIONS.TICKETS_READ_ALL,
      PERMISSIONS.TICKETS_UPDATE_ALL,
  ...
  PRINCIPAL: {
    slug: 'principal',
    name: 'Principal',
    description: 'School leader with full operational access to their school',
    permissions: [
      PERMISSIONS.TICKETS_CREATE,
      PERMISSIONS.TICKETS_READ_ALL,
      PERMISSIONS.TICKETS_UPDATE_ALL,
