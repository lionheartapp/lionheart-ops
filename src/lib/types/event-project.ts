...
export const CreateEventProjectSchema = z.object({
  ...
  isOffCampus: z.boolean().optional().default(false),
  venueName: z.string().max(300).optional(),
  venueAddress: z.string().max(500).optional(),
  venuePlaceId: z.string().max(300).optional(),
