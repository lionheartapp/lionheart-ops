      ...
      <div className="space-y-6">
        <div className="-mt-6 lg:-mt-8 -mx-4 sm:-mx-10 px-4 sm:px-10 py-5 bg-white/60 backdrop-blur-sm border-b border-slate-200/60">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h3 className="text-lg font-semibold text-slate-900">Single Sign-On</h3>
    ...
    <div className="space-y-8">
      ...
      <div className="flex items-center gap-3">
        <button
          ...
          className="px-6 py-2.5 bg-slate-900 text-white text-sm font-medium rounded-full hover:bg-slate-800 disabled:opacity-50 disabled:cursor-not-allowed transition-colors cursor-pointer"
        >
