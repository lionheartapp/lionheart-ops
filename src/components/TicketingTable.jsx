...
export default function TicketingTable() {
  ...
  useEffect(() => {
    let cancelled = false
    platformFetch('/api/events/ticket-sales')
    ...
    >
      <div className="p-4 border-b border-zinc-200 dark:border-zinc-700 dark:border-blue-950/40">
        <div className="flex items-center gap-2 flex-wrap">
          ...
          {usePlaceholder && (
            <span className="text-xs px-2 py-0.5 rounded bg-amber-100 dark:bg-amber-900/40 text-amber-800 dark:text-amber-200 border border-amber-300 dark:border-amber-700">
              Sample data
            </span>
          )}
        </div>
