    ...
    <div className="space-y-8" onPaste={handlePaste}>
      ...
      <section className="bg-white border border-gray-200 rounded-xl p-6 space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            <label htmlFor="av-manufacturer" className="block text-sm font-medium text-gray-700 mb-1">
              Manufacturer
            </label>
            <input
              id="av-manufacturer"
          ...
          <div>
            <label htmlFor="av-model" className="block text-sm font-medium text-gray-700 mb-1">
              Model
            </label>
            <input
              id="av-model"
        ...
        <div>
              ...
              {serialNumbers.map((sn) => (
                ...
                >
                  ...
                  <button
                    ...
                    className="ml-0.5 text-gray-400 hover:text-red-600 transition-colors cursor-pointer"
          ...
          <div className="flex gap-2">
            ...
            <button
              ...
              className="px-4 py-2.5 text-sm font-medium border border-gray-200 rounded-lg text-gray-700 bg-white hover:bg-gray-50 transition-colors disabled:opacity-40 cursor-pointer flex items-center gap-1.5"
            >
      ...
      <section className="bg-white border border-gray-200 rounded-xl p-6 space-y-5">
        <h3 className="text-sm font-semibold text-gray-900">Media &amp; documents</h3>
        ...
        <div>
          ...
          {imageUrl ? (
            <div className="relative w-[200px] h-[200px] rounded-lg overflow-hidden border border-gray-200 group">
              <img
                src={imageUrl}
                alt="Product"
        ...
        <div>
          ...
          <div className="bg-gray-50 border border-gray-100 rounded-lg p-4 space-y-3">
            ...
            <button
              ...
              className="w-full px-4 py-2 text-sm font-medium border border-gray-200 rounded-lg text-gray-700 bg-white hover:bg-gray-50 transition-colors disabled:opacity-40 cursor-pointer flex items-center justify-center gap-1.5"
            >
            ...
            {showNewTag ? (
              <div className="flex items-center gap-1">
                <input
                  ...
                  className="px-2.5 py-1 text-xs border border-gray-200 rounded-full bg-white focus:outline-none focus-visible:ring-2 focus-visible:ring-gray-200 w-28"
              ...
              <button
                ...
                className="px-3 py-1.5 rounded-full text-xs font-medium bg-gray-900 text-white hover:bg-gray-800 transition-colors cursor-pointer flex items-center gap-1"
              >
