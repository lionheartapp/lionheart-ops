    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="ui-glass p-4 text-center">
          ...
          <div className="text-xs text-slate-500 mt-0.5">Flagged Devices</div>
        </div>
        ...
        <div className="ui-glass p-4 text-center">
          ...
          <div className="text-2xl font-bold text-slate-900">{summary.repairCount}</div>
          <div className="text-xs text-slate-500 mt-0.5">Recommended Repair</div>
        </div>
        ...
        <div className="ui-glass p-4 text-center">
          ...
          <div className="text-2xl font-bold text-slate-900">{summary.replaceCount}</div>
          <div className="text-xs text-slate-500 mt-0.5">Recommended Replace</div>
        </div>
      ...
      <div className="ui-glass p-6">
        ...
        {lemons.length === 0 ? (
          <div className="text-center py-12">
            ...
            <p className="text-sm font-medium text-slate-900">No lemon devices</p>
                  ...
                  >
                    ...
                    <td className="py-3 px-4">
                      ...
                      {device.aiRecommendation?.reasoning && (
                        <p className="text-xs text-slate-500 mt-1 max-w-[200px] truncate" title={device.aiRecommendation.reasoning}>
                          {device.aiRecommendation.reasoning}
                        </p>
                      )}
                    </td>
                    ...
                    {canManage && (
                      <td className="py-3 px-4 text-right">
                        <button
                          ...
                          className="px-3 py-1.5 rounded-full bg-white border border-slate-200 text-slate-700 text-xs font-medium hover:bg-slate-50 active:scale-[0.97] transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
                        >
      ...
      {canConfigure && (
        <div className="ui-glass p-6">
          ...
          {/* Save button */}
          {!configLoading && (
            <div className="flex justify-end mt-6 pt-4 border-t border-slate-200/50">
              <button
                onClick={() => {
