    ...
    <div className="space-y-4">
      ...
      {batches.length === 0 ? (
        <div className="ui-glass p-12 text-center">
          ...
          <p className="text-sm font-medium text-slate-600 mb-1">No deployment batches yet</p>
          ...
          {canManage && (
            <button
              onClick={onCreateBatch}
              className="mt-4 inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-slate-900 text-white text-sm font-medium hover:bg-slate-800 active:scale-[0.97] transition-all"
            >
              <Plus className="w-4 h-4" />
              Create Batch
            </button>
