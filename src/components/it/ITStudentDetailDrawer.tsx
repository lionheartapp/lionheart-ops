        ...
        <div className="flex flex-col h-full">
          ...
          <div className="px-6 py-4 border-b border-gray-200/50">
            ...
            {student.activeAssignments && student.activeAssignments.length > 0 ? (
                  ...
                  <div key={a.id} className="bg-gray-50 rounded-lg p-3 flex items-center justify-between">
                    <div>
                      <div className="flex items-center gap-2 mb-1">
                        <span className="font-mono text-xs text-gray-700">{a.device.assetTag}</span>
              ...
              <p className="text-xs text-gray-400">No devices currently assigned</p>
            )}
          </div>
                ...
                {student.allAssignments.map((a) => (
                  <div key={a.id} className="flex items-center justify-between text-xs text-gray-600 py-1">
                    <div className="flex items-center gap-2">
                      <span className="font-mono text-gray-500">{a.device.assetTag}</span>
          ...
          {canManage && (
            <div className="px-6 py-4">
              {showDeleteConfirm ? (
                <div className="space-y-2">
                  <p className="text-sm text-gray-700">Delete this student record? This action cannot be undone.</p>
