        ...
        >
          {items.map((item) => (
            <button
              ...
              className="flex-shrink-0 px-4 py-2 text-sm font-medium rounded-full bg-slate-100 text-slate-600 hover:bg-slate-200 transition-colors duration-200 cursor-pointer whitespace-nowrap active:scale-[0.97] min-h-[36px]"
              aria-label={item}
            >
              {item}
            </button>
