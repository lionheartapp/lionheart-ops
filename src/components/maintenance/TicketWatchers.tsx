      ...
      <div className="flex items-center flex-wrap gap-1.5">
        ...
        <div className="relative" ref={popoverRef}>
          <button
            ...
            className="w-7 h-7 rounded-full border border-dashed border-slate-300 flex items-center justify-center text-slate-400 hover:border-slate-400 hover:text-slate-500 transition-colors cursor-pointer"
            title="Add watcher"
          >
