            ...
            <div className="space-y-2.5">
              {[1, 2, 3, 4, 5, 6, 7, 8].map((i) => (
                <div key={i} className="flex items-center gap-3">
                  ...
                  <div className="h-3 w-4 bg-slate-100 rounded flex-shrink-0" />
                </div>
              ))}
            </div>
          </div>
            ...
            <div className="space-y-2">
              {[1, 2, 3].map((i) => (
                <div key={i} className="flex items-center gap-3 py-1.5">
                  ...
                  <div className="ml-auto h-4 w-8 bg-slate-100 rounded" />
                </div>
              ))}
            </div>
          </div>
            ...
            <div className="space-y-2">
              {[1, 2, 3].map((i) => (
                <div key={i} className="flex items-center gap-3 py-1.5">
                  ...
                  <div className="ml-auto h-4 w-6 bg-slate-100 rounded" />
                </div>
              ))}
            </div>
          </div>
