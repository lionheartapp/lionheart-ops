...
function getWarrantyBadge(warrantyExpiry: string | null | undefined) {
  if (!warrantyExpiry) return { label: 'N/A', color: 'bg-gray-100 text-gray-500' }
    ...
    <div className="space-y-4 animate-pulse">
      ...
      <div className="ui-glass p-6">
        <div className="flex gap-6">
          ...
          <div className="flex-1 space-y-2">
            <div className="h-6 bg-gray-100 rounded-lg w-64" />
      ...
      {[1, 2, 3].map((i) => (
        <div key={i} className="ui-glass p-6">
          <div className="h-4 bg-gray-100 rounded-lg w-32 mb-4" />
  ...
  if (error || !asset) {
    return (
      <div className="ui-glass p-8 text-center">
        ...
        <p className="text-gray-600">Failed to load asset details</p>
        <button
          type="button"
          onClick={() => refetch()}
      ...
      >
        ...
        <motion.div variants={fadeInUp}>
          <button
            ...
            className="flex items-center gap-2 text-sm text-gray-500 hover:text-gray-700 transition-colors cursor-pointer mb-2"
          >
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-start justify-between gap-3 mb-2">
                ...
                <button
                  ...
                  className="flex items-center gap-1.5 px-3 py-1.5 text-sm font-medium border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors cursor-pointer flex-shrink-0"
                >
              ...
              <dl className="grid grid-cols-1 sm:grid-cols-3 gap-x-4 gap-y-1 text-sm mb-3">
                {asset.make && (
                  <>
                    ...
                    <dd className="text-gray-700 sm:col-span-2">{asset.make}</dd>
                  </>
                )}
                {asset.model && (
                  <>
                    <dt className="text-gray-400">Model</dt>
                    <dd className="text-gray-700 sm:col-span-2">{asset.model}</dd>
                  </>
                )}
                {asset.serialNumber && (
                  <>
                    <dt className="text-gray-400">Serial</dt>
                    <dd className="text-gray-700 font-mono text-xs sm:col-span-2">{asset.serialNumber}</dd>
                  </>
                )}
              </dl>
        ...
        <motion.div variants={fadeInUp} className="ui-glass p-6">
          ...
          {asset.ticketHistory.length === 0 ? (
            <div className="text-center py-8">
              ...
              <p className="text-sm text-gray-400">No tickets linked to this asset yet</p>
            </div>
          ) : (
        ...
        <motion.div variants={fadeInUp} className="ui-glass p-6">
          ...
          {asset.pmSchedules.length === 0 ? (
            <div className="text-center py-8">
              ...
              <p className="text-sm text-gray-400">No PM schedules for this asset</p>
              <p className="text-xs text-gray-400 mt-1">PM schedules will be created in Phase 4 Plan 03</p>
            </div>
          ) : (
