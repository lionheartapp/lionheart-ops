  ...
  return (
    <div className="relative">
      ...
      <input
        ...
        className="ui-glass w-full pl-9 pr-9 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-400 transition-shadow"
