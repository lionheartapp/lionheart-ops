  ...
  return (
    ...
    >
      <style>{`
        ...
        .tm-icon { opacity: 0; animation: tm-bounceIn 0.5s cubic-bezier(0.34, 1.56, 0.64, 1) 0.5s forwards; }
      ...
      {/* Center person */}
      <g className="tm-center">
        <g transform="translate(104, 62)">
          <circle cx="16" cy="16" r="16" fill="url(#team-aurora)" opacity="0.7" />
          <path d="M0,52 C0,40 8,34 16,34 C24,34 32,40 32,52 L32,60 C32,62 30,64 28,64 L4,64 C2,64 0,62 0,60 Z" fill="url(#team-aurora)" opacity="0.5" />
      ...
      <g className="tm-left">
        <g transform="translate(50, 80)">
          ...
          <path d="M0,44 C0,34 6,28 14,28 C22,28 28,34 28,44 L28,52 C28,54 26,56 24,56 L4,56 C2,56 0,54 0,52 Z" fill="url(#team-aurora)" opacity="0.25" />
      ...
      {/* Shield */}
      <g className="tm-icon" style={{ transformOrigin: '174px 62px' }}>
      ...
      {/* Badge */}
      <g className="tm-icon" style={{ transformOrigin: '66px 64px' }}>
      ...
      <g className="tm-sparkle" style={{ transformOrigin: '189px 134px' }}>
        <g transform="translate(185, 130)">
          <path d="M4 0 L5 3 L8 4 L5 5 L4 8 L3 5 L0 4 L3 3 Z" fill="#6366F1" opacity="0.3" />
        </g>
      </g>
      <g className="tm-sparkle" style={{ transformOrigin: '45px 123px' }}>
