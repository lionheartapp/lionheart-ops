  ...
  return (
    ...
    >
      <style>{`
        ...
        @keyframes ath-starBounce { from { opacity: 0; transform: scale(0); } to { opacity: 1; transform: scale(1); } }
        @keyframes ath-laurelL { from { opacity: 0; transform: translateX(-8px); } to { opacity: 0.35; transform: translateX(0); } }
        @keyframes ath-laurelR { from { opacity: 0; transform: translateX(8px); } to { opacity: 0.35; transform: translateX(0); } }
      ...
      {/* Star */}
      <g className="ath-star" style={{ transformOrigin: '120px 34px' }}>
      ...
      <g className="ath-sparkle" style={{ transformOrigin: '179px 99px' }}>
        <g transform="translate(175, 95)">
          <path d="M4 0 L5 3 L8 4 L5 5 L4 8 L3 5 L0 4 L3 3 Z" fill="#6366F1" opacity="0.3" />
        </g>
      </g>
      <g className="ath-sparkle" style={{ transformOrigin: '55px 53px' }}>
