  ...
  return (
    ...
    >
      <style>{`
        ...
        .cmp-tree { opacity: 0; animation: cmp-treePop 0.4s cubic-bezier(0.34, 1.56, 0.64, 1) 0.5s forwards; }
        ...
        @keyframes cmp-treePop { from { opacity: 0; transform: scale(0.3); } to { opacity: 1; transform: scale(1); } }
      ...
      {/* Trees */}
      <g className="cmp-tree" style={{ transformOrigin: '46px 148px' }}>
      ...
      <g className="cmp-tree" style={{ transformOrigin: '204px 150px' }}>
      ...
      <g className="cmp-sparkle" style={{ transformOrigin: '45px 98px' }}>
