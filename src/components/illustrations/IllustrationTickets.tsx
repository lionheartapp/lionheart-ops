  ...
  return (
    ...
    >
      <style>{`
        ...
        @keyframes tix-floatInR { from { opacity: 0; transform: translate(12px, -8px); } to { opacity: 1; transform: translate(0, 0); } }
        @keyframes tix-floatInL { from { opacity: 0; transform: translate(-12px, -8px); } to { opacity: 1; transform: translate(0, 0); } }
      ...
      {/* Task rows — each wrapped so animation doesn't override position */}
      <g className="tix-row1">
      ...
      {/* Sparkle stars */}
      <g className="tix-sparkle" style={{ transformOrigin: '189px 119px' }}>
        <g transform="translate(185, 115)">
          <path d="M4 0 L5 3 L8 4 L5 5 L4 8 L3 5 L0 4 L3 3 Z" fill="#6366F1" opacity="0.3" />
        </g>
      </g>
      <g className="tix-sparkle" style={{ transformOrigin: '53px 55px' }}>
