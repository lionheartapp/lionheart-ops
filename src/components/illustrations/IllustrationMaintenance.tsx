...
export function IllustrationMaintenance({ className = '' }: { className?: string }) {
  return (
    ...
    >
      ...
      {/* Background circle */}
      <circle cx="120" cy="105" r="75" fill="url(#maint-aurora-light)" />

      {/* Decorative dots */}
      <circle cx="44" cy="72" r="3" fill="#3B82F6" opacity="0.2" />
      <circle cx="200" cy="58" r="2.5" fill="#6366F1" opacity="0.25" />
      <circle cx="196" cy="155" r="2" fill="#3B82F6" opacity="0.15" />
      ...
      {/* Sparkle/check — fixed! */}
      <g transform="translate(160, 58)" opacity="0.5">
        <circle cx="10" cy="10" r="10" fill="url(#maint-aurora)" opacity="0.15" />
        <path d="M5,10 L9,14 L16,6" stroke="url(#maint-aurora)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
      </g>

      {/* Sparkle stars */}
      <g transform="translate(60, 155)" opacity="0.3">
        <path d="M4 0 L5 3 L8 4 L5 5 L4 8 L3 5 L0 4 L3 3 Z" fill="#6366F1" />
      </g>
      <g transform="translate(180, 85)" opacity="0.25">
