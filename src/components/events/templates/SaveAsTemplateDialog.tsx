      ...
      <div className="flex min-h-full items-center justify-center p-4">
        ...
        >
          ...
          <div className="p-6 sm:p-8">
            <h3 id="save-template-title" className="text-xl font-semibold text-slate-900 mb-1">
              Save as Template
            </h3>
            ...
            <div className="mt-6 flex flex-col-reverse sm:flex-row gap-3">
              <button
                ...
                onClick={onClose}
                disabled={isSaving}
                className="flex-1 px-5 py-2.5 rounded-full border border-slate-200 text-sm font-medium text-slate-700 hover:bg-slate-50 active:scale-[0.97] transition-all cursor-pointer disabled:opacity-50"
              >
                Cancel
              </button>
              <button
