...
export default function TopBar({
  ...
  return (
    <header className="relative z-50 shrink-0 flex items-center gap-4 px-6 lg:px-8 py-3 border-b border-zinc-200 dark:border-zinc-800 bg-zinc-50/80 dark:bg-zinc-900/80 backdrop-blur-sm">
      {/* Search - left */}
