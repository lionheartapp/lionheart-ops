...
const FEATURES = [
  {
    ...
    description: 'AI-parsed requests with automatic inventory and spatial conflict detection.',
  },
  {
    icon: ShieldCheck,
    title: 'Facilities & IT',
    description: 'Tiered ticketing with safety-mode overlays and man-hour tracking.',
  },
  {
    icon: Map,
    title: '360° Campus Map',
    description: 'Interactive Matterport tours with deep-linked room pins and schedules.',
  },
]
    ...
    <div className="min-h-screen bg-white text-zinc-900 font-sans">
      <nav className="flex items-center justify-between px-6 py-4 border-b border-zinc-100 max-w-7xl mx-auto w-full">
        ...
        <div className="hidden md:flex items-center gap-8 text-sm font-medium text-zinc-600">
          ...
          <Link href="/login" className="hover:text-primary-600">Sign in</Link>
          <Link href="/signup" className="px-4 py-2 bg-primary-900 text-white rounded-full hover:bg-primary-800 transition-all">
            Get Started
          </Link>
        </div>
      </nav>
          ...
          <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link href="/signup" className="px-8 py-4 rounded-xl bg-primary-600 text-white font-bold text-lg hover:bg-primary-700 transition-all shadow-xl shadow-primary-200 flex items-center justify-center gap-2">
                  Start for Free <ArrowRight className="w-5 h-5" />
                </Link>
                <Link href="/campus" className="px-8 py-4 rounded-xl border-2 border-zinc-200 text-zinc-700 font-bold text-lg hover:bg-zinc-50 transition-all flex items-center justify-center gap-2">
                  View Campus Demo
                </Link>
              </div>
            </div>
          ...
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {FEATURES.map((feature) => (
                <div key={feature.title} className="p-8 rounded-2xl bg-white border border-zinc-200 hover:shadow-xl transition-all group">
