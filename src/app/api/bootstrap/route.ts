...
export async function GET(req: NextRequest) {
  try {
    return await withOrg(req, prismaBase, async () => {
      ...
      const systemFormIds = {
        event: typeof systemFormIdsRaw.event === 'string' ? systemFormIdsRaw.event : DEFAULT_SYSTEM_FORM_IDS.event,
        tech: typeof systemFormIdsRaw.tech === 'string' ? systemFormIdsRaw.tech : DEFAULT_SYSTEM_FORM_IDS.tech,
        facilities: typeof systemFormIdsRaw.facilities === 'string' ? systemFormIdsRaw.facilities : DEFAULT_SYSTEM_FORM_IDS.facilities,
        it: typeof systemFormIdsRaw.it === 'string' ? systemFormIdsRaw.it : DEFAULT_SYSTEM_FORM_IDS.it,
      }
