...
// eslint-disable-next-line no-restricted-imports -- External calendar events are per-user integration records; route filters by orgId and ctx.userId.
...
/**
 * @authOnly Returns only external calendar events connected to the signed-in user.
 *
